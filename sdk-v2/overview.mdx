...
Some simulators are Desktop VMs where the agent operates the VM itself — mouse, keyboard, shell, and files — rather than just browsing to an app URL. See [Desktop VMs](/sdk-v2/desktop-vms).
...
<CardGroup cols={2}>
  ...
  <Card title="Desktop VMs" icon="desktop" href="/sdk-v2/desktop-vms">
    Full Desktops: in-VM login, computer/bash/edit tooling
  </Card>
</CardGroup>
